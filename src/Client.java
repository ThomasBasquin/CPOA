...
public class Client {
    ...
    public void update(String nom , String prenom , String no_rue , String voie , String zip , String ville , String pays , int id){
        try{
            Statement requete = laConnexion.createStatement();
            PreparedStatement req = laConnexion.prepareStatement("update Client set nom = ? , prenom = ? , no_rue = ? , voie = ? , zip = ? , ville = ? , pays = ? where id_client = ?)", Statement.RETURN_GENERATED_KEYS);
